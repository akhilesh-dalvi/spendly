...
function EmojiPicker({
	className,
	...props
}: ComponentPropsWithoutRef<typeof EmojiPickerPrimitive.Root>) {
	return (
...
function EmojiPickerSearch({
	className,
	...props
}: ComponentPropsWithoutRef<typeof EmojiPickerPrimitive.Search>) {
	return (
		<div
...
function EmojiPickerContent({
	className,
	...props
}: ComponentPropsWithoutRef<typeof EmojiPickerPrimitive.Viewport>) {
	return (
