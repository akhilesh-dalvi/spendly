...
function Dialog({ ...props }: ComponentPropsWithoutRef<typeof DialogRoot>) {
	return <DialogRoot data-slot="dialog" {...props} />;
}

function DialogTrigger({
	...props
}: ComponentPropsWithoutRef<typeof DialogTriggerPrimitive>) {
	return <DialogTriggerPrimitive data-slot="dialog-trigger" {...props} />;
}

function DialogPortal({
	...props
}: ComponentPropsWithoutRef<typeof DialogPortalPrimitive>) {
